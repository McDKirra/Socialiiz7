...
import {ISocialiiz7State} from './ISocialiiz7State';
...
export function creatEntryTypeChoices(parentProps:ISocialiiz7Props , parentState: ISocialiiz7State, _onChange){
