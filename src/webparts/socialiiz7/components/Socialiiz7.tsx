...
import styles from './Socialiiz7.module.scss';
import { ISocialiiz7Props, IEntity } from './ISocialiiz7Props';
...
import {IUser, ISocialiiz7State, IMyPivots, IPivot,} from './ISocialiiz7State';
...
export default class Socialiiz7 extends React.Component<ISocialiiz7Props, ISocialiiz7State> {
  ...
  public constructor(props:ISocialiiz7Props){
    super(props);
...
*/
  ...
  public render(): React.ReactElement<ISocialiiz7Props> {
...
*/
    ...
    return (
      <div className={ styles.socialiiz7 }>
  ...
  public createPivots(pivots: IPivot[], thisProps: ISocialiiz7Props){
